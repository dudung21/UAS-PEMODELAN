    ...
    <script>
        $(document).ready(function() {
            ...
            $('#generate').click(function() {
                ...
                $.ajax({
                    ...
                    url: "http://localhost/macdonald/api/operasi/generate-by-avg.php",
            ...
            $('#sample_form').on('submit', function(event) {
                ...
                if ($('#action').val() == "Add") {
                    ...
                    $.ajax({
                        url: "http://localhost/macdonald/api/operasi/create.php",
                        method: "POST",
                    ...
                    $.ajax({
                        url: "http://localhost/macdonald/api/operasi/update.php",
                        method: "PUT",
                        data: JSON.stringify(formData),
                        success: function(data) {
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                type: "GET",
                contentType: "application/json",
                url: "http://localhost/macdonald/api/operasi/read.php",
                success: function(response) {
                    ...
                    for (var i = 0; i < json.length; i++) {
                        var sub_array = {
                            ...
                            'action': '<div class="btn-group" role="group">' +
                                '<button onclick="showOne(' + json[i].id + ')" class="btn btn-sm btn-warning">Edit</button>' +
        ...
        function showOne(id) {
            ...
            $.ajax({
                type: "GET",
                contentType: "application/json",
                url: "http://localhost/macdonald/api/operasi/read.php?id=" + id,
                success: function(response) {
                    $('#id').val(response.id);
        ...
        function deleteOne(id) {
            ...
            $.ajax({
                url: "http://localhost/macdonald/api/operasi/delete.php",
                method: "DELETE",
                data: JSON.stringify({
                    "id": id
                }),
